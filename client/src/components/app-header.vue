        ...
        <header class="header__1 js-header">
            <div class="container">
                <div class="wrapper js-header-wrapper">
                    ...
                    <div class="d-flex align-items-center space-x-20" v-if="connected">
                        <div class="header__notifications">
                            ...
                            <div class="notifications_popup space-y-20">
                                <div class="d-flex justify-content-between">
                                    <h5> Notifications</h5>
                                    <router-link to="/activity" class="badge
                                color_white">View
                                        all
                                    </router-link>
                                </div>
                                <div class="item space-x-20 d-flex
                            ...
                            align-items-center">
                                    ...
                                    />
                                    <div class="details">
                                        <router-link to="/activity"><h6>Money
                                            revieved</h6>
                                        </router-link>
                                        <p>0.6 ETH</p>
                                    </div>
